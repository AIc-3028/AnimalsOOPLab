...
public class AmericanCrow extends Corvus{
    ...
    public AmericanCrow(String species, String name, String featherColor, int wingspan, String beakColor, String beakShape, int bodyLength) {
        this.species = species;
        this.name = name;
        this.featherColor = featherColor;
        this.wingspan = wingspan;
