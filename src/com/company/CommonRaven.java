...
public class CommonRaven extends Corvus{
    ...
    public CommonRaven(String species, String name, String featherColor, int wingspan, String beakColor, String beakShape, int bodyLength) {
        this.species = species;
        this.name = name;
        this.featherColor = featherColor;
        this.wingspan = wingspan;
