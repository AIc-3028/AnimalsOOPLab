...
public class GreyParrot extends Psittacus{
    ...
    public GreyParrot(String species, String name, String featherColor, int wingspan, String beakColor, String beakShape, int bodyLength) {
        this.species = species;
        this.name = name;
        this.featherColor = featherColor;
        this.wingspan = wingspan;
